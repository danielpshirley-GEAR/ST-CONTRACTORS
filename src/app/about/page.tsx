...
export default function AboutPage() {
  ...
  return (
    <div className="bg-white text-slate-900 min-h-screen">
      ...
      {/* 3.5. MASTER CRAFTSMANSHIP & SITE INTEGRITY (ATMOSPHERIC VIDEO SHOWCASE) */}
      <section className="relative py-20 sm:py-28 overflow-hidden text-white border-b border-neutral-900">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          <video
            ...
            aria-hidden="true"
          >
            <source src="/videos/fitted-joinery-cabinet.mp4" type="video/mp4" />
          </video>
        ...
        <Container className="relative z-10">
          <div className="text-left max-w-3xl mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-white font-heading leading-tight drop-shadow-md">
              The Art of Master Joinery &amp; Trade Integrity
            </h2>
            <p className="mt-4 text-base sm:text-lg text-neutral-200 leading-relaxed font-normal drop-shadow-sm">
              True architectural quality isn’t just what looks good on handover day. It’s the invisible precision behind the walls—unvented plumbing manifolds, laser-leveled subfloors, and bespoke joinery built to endure.
            </p>
          </div>

          {/* Luminous Liquid Glass Container */}
          <div className="w-full bg-white/[0.14] backdrop-blur-3xl p-6 sm:p-10 rounded-3xl border border-white/40 shadow-[inset_0_1px_2px_rgba(255,255,255,0.7),0_25px_60px_rgba(0,0,0,0.4)] relative overflow-hidden before:absolute before:inset-0 before:bg-gradient-to-b before:from-white/25 before:via-white/[0.04] before:to-transparent before:pointer-events-none">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
              <div className="p-6 rounded-2xl bg-white/10 backdrop-blur-md border border-white/25 text-left shadow-sm flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-neutral-200 leading-relaxed font-normal">
                    Precision wardrobes, alcove storage, and kitchen cabinetry hand-fitted with soft-close hardware and seamless shadow gaps.
                  </p>
                </div>
                <div className="mt-5 pt-3 border-t border-white/15 text-[11px] font-bold text-[#FFAA4F] uppercase tracking-wider">
                  Direct In-House Carpenters
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-white/10 backdrop-blur-md border border-white/25 text-left shadow-sm flex flex-col justify-between">
                <div>
                  <div className="flex items-center gap-2 mb-3">
                    <CheckCircle2 className="h-5 w-5 text-[#FFAA4F] flex-shrink-0" aria-hidden="true" />
                    <h3 className="text-base sm:text-lg font-bold text-white font-heading">
                      Engineered MEP Infrastructure
                    </h3>
                  </div>
                  <p className="text-xs sm:text-sm text-neutral-200 leading-relaxed font-normal">
                    Pressure-tested manifold plumbing, acoustic waste pipe insulation, and certified NICEIC/Part P distribution boards.
                  </p>
                </div>
                <div className="mt-5 pt-3 border-t border-white/15 text-[11px] font-bold text-[#FFAA4F] uppercase tracking-wider">
              ...
              <div className="p-6 rounded-2xl bg-white/10 backdrop-blur-md border border-white/25 text-left shadow-sm flex flex-col justify-between">
                <div>
                  <div className="flex items-center gap-2 mb-3">
                    <Shield className="h-5 w-5 text-[#FFAA4F] flex-shrink-0" aria-hidden="true" />
                    <h3 className="text-base sm:text-lg font-bold text-white font-heading">
                      Immaculate Site Discipline
                    </h3>
                  </div>
                  <p className="text-xs sm:text-sm text-neutral-200 leading-relaxed font-normal">
                    Zip-sealed dust containment zones, floor protection sheeting, HEPA filtration, and respectful daily liaison with your neighbours.
                  </p>
                </div>
                <div className="mt-5 pt-3 border-t border-white/15 text-[11px] font-bold text-[#FFAA4F] uppercase tracking-wider">
                  Respectful Residential Teams
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-white/20 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 relative z-10">
              <div className="text-xs sm:text-sm text-white/90 font-medium">
                Want to see our craftsmanship in person? We arrange escorted tours of active and completed local projects.
              </div>
